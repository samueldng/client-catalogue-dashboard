...
import { Plus, Search, Edit, Trash2, X } from "lucide-react"; // Importando o ícone de "X"
      ...
      {isFormOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"> {/* Overlay com z-index alto */}
          <div className="bg-white rounded-lg p-6 w-full max-w-md z-50 relative">
            ...
            <Button
              onClick={closeForm}
              className="absolute top-2 right-2 bg-transparent border-0 text-gray-500 hover:text-gray-800"
            >
              <X className="w-6 h-6" />
            </Button>
